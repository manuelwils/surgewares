<header class="Page-header">
    <div class="Page-header-bar">
        <div class="Page-header-bar-logo">
            <a aria-label="home page" href="{{ env('APP_URL') }}" wire:navigate style="font-size:18px">
        ...
        <div class="Page-header-eyebrow">
            <a class="Link" href="{{ route(\App\Http\Controllers\RoutesController::$products) }}" wire:navigate>Products</a>
        </div>
    </div>
</header>